...
if st.checkbox('Show me price prediction'):
    st.subheader(
        f"You have selected {airline_name} airlines from {source_city_name} to {destination_city_name} in {departure_time_name}.")
...
if (st.button("About")):
    st.text("Welcome To My First ML Web App!!!   - Credits- Rupesh D")